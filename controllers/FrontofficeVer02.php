...
/*
	...
	public function export2pdf_tinymce(){
		...
		export_html_ke_pdf($file_html,$output_dest='D',$_POST['nama_file'],$nama_satker='BKD Prov. Sulawesi Selatan',$nama_bidang='Front Office BKD',$lebar_page=270,$tinggi_page=330,$orientasi='');
	}
