...
$(document).ready(function(){
	$(".register").click(function(){
		...
		tampilkan.hide();
		loading.fadeIn(); 
		$.post('<?php echo site_url('/Frontoffice/pra_register_pegawai');?>',{ data:"okbro"},
	...
	$("#lupa_password").click(function(){
		...
		tampilkan.hide();
		loading.fadeIn(); 
		$.post('<?php echo $this->config->item('bank_data')."/index.php/Frontoffice/lupa_password/identpeg";?>',{ data:"okbro"},
		function(data,status){
			loading.fadeOut();
			tampilkan.html(data);
			tampilkan.fadeIn(2000);
