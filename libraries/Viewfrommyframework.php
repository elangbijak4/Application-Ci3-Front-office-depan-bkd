...
class Viewfrommyframework {
    ...
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        ...
        if (!$Recordset1) {
            ...
            if(isset($Recordset[0])){
                ...
                $i=0;
                foreach($Recordset as $keyisi=>$isi){
                    if($isi['status_surat']!='diteruskan'){
                        echo "<tr>";
                        //$tampung=array_values($isi); 
                        $i++;
                        echo "
                        ...
                        */
                        ...
                        <button class=\"d-sm-inline-block btn btn-sm btn-danger shadow-sm kotak\" style=\"width:13%;margin-top:5px;\" id=\"tolak$keyisi\" data-toggle=\"modal\" data-target=\"#modal_verifikasi_sedang\"><i class='fas fa-backward fa-sm text-white-100'></i> <br>Tolak</button>
                        <button class=\"d-sm-inline-block btn btn-sm btn-info shadow-sm kotak\" style=\"width:13%;margin-top:5px;\" id=\"detail_surat$keyisi\" ><i class='fas fa-cog fa-sm text-white-100'></i> <br>Detail</button>
                        <button disabled class=\"d-sm-inline-block btn btn-sm btn-primary shadow-sm kotak\" style=\"width:15.5%;margin-top:5px;\" id=\"unggah_balasan$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-upload fa-sm text-white-100'></i> <br>Unggah Balasan</button>
                        </td></tr>";
                        ...
                        $(document).ready(function(){
                            $(\"#teruskan_new$keyisi\").click(function(){
                                ...
                                loading.html('Persiapan pengiriman dengan memuat data ke memori...loading..<br><i class=\"fa-3x fas fa-spinner fa-pulse\" ".$this->CI->config->item('style_progres_bulat_admin')."></i>');
                                loading.fadeIn(); 
                                $.post('".site_url('/Frontoffice/verifikasi_new')."',{key:\"".$tampung_key[0]."\",data:\"".$isi[$tampung_key[0]]."\" },
                                function(data,status){
                                    loading.fadeOut();
                                    tampilkan.html(data);
                                    tampilkan.fadeIn(2000);
    ...
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi_rencana ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        $Recordset1=$this->CI->model_frommyframework->user_defined_query_model($query_yang_mau_ditampilkan,$token='andisinra');
        //var_dump($Recordset1);
        if (!$Recordset1) {
            echo "<center>TABEL YANG BERSESUAIAN KOSONG, SILAHKAN DIISI DULU</center>";
            ...
            if(isset($Recordset[0])){
                ...
                //echo "<h4>Kelola Surat Masuk</h4>";
                //print_r($_SERVER);
                echo "<div ".$array_atribut[0]." ><table class=\"table table-bordered\" ><tr ".$array_atribut[2]." >";//<table ".$array_atribut[1]." ><tr ".$array_atribut[2]." >";
                echo "<th scope='col' ><span >Aksi</span></th>";
                if(in_array($kolom_direktori,$tampung_key)){
                    echo "<th ><span >Foto</span></th>";
                }
                ...
                foreach($Recordset as $keyisi=>$isi){
                    ...
                    */
                    ...
                    $rentang=sizeof($kolom_cari)+1;
                    echo "<tr align=\"left\" id=\"rincian_surat3$keyisi\">
                    <td colspan=".$rentang.">
                    <center>
                    <i class='fa-3x fas fa-spinner fa-pulse' ".$this->CI->config->item('style_progres_bulat_admin')."></i>
                    </center>
                    ...
                    */
					...
					$(document).ready(function(){
						...
						$(\"#eyebuka$keyisi\").click(function(){
							$('#rincian_surat$keyisi').toggle(1000);
							$('#rincian_surat_2$keyisi').hide(1000);
							$('#rincian_surat_3$keyisi').hide(1000);
                        });
                        ...
                        */
                        ...
                        $(\"#detail_surat$keyisi\").click(function(){
                            //var loading = $(\"#pra_rincian$keyisi\");
                            var tampilkan = $(\"#rincian_surat3$keyisi\");
                            tampilkan.show(2000);
                            //loading.fadeIn(); 
                            $.post('".site_url('/Frontoffice/tampilkan_rincian_surat_frontoffice/'.$size)."',{key:\"".$tampung_key[0]."\",data:\"".$isi[$tampung_key[0]]."\" },
                            function(data,status){
                                //loading.fadeOut();
                                tampilkan.html(data);
                                tampilkan.fadeIn(2000);
    ...
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi_cara_0 ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        $Recordset1=$this->CI->model_frommyframework->user_defined_query_model($query_yang_mau_ditampilkan,$token='andisinra');
        //var_dump($Recordset1);
        if (!$Recordset1) {
            echo "<center>TABEL YANG BERSESUAIAN KOSONG, SILAHKAN DIISI DULU</center>";
            ...
            if(isset($Recordset[0])){
                ...
                foreach($Recordset as $keyisi=>$isi){
                    ...
                    */
                    ...
                    <td colspan=".$size." align='justify'>
                    <button class=\"d-sm-inline-block btn btn-sm btn-success shadow-sm kotak\" style=\"width:18.5%;margin-top:5px;\" id=\"isiSurat$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-envelope-open fa-sm text-white-100'></i> <br>Buka Surat</button>
                    <button class=\"d-sm-inline-block btn btn-sm btn-info shadow-sm kotak\" style=\"width:18.5%;margin-top:5px;\" id=\"berkasSurat$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-folder-open fa-sm text-white-100'></i> <br>Berkas Pendukung</button>
                    <button class=\"d-sm-inline-block btn btn-sm btn-primary shadow-sm kotak\" style=\"width:15%;margin-top:5px;\" id=\"teruskan_new$keyisi\" data-toggle=\"modal\" data-target=\"#modal_verifikasi\"><i class='fas fa-forward fa-sm text-white-100'></i> <br>Teruskan</button>
                    <button class=\"d-sm-inline-block btn btn-sm btn-warning shadow-sm kotak\" style=\"width:15%;margin-top:5px;\" id=\"pending$keyisi\" data-toggle=\"modal\" data-target=\"#modal_verifikasi_sedang\"><i class='fas fa-pause fa-sm text-white-100'></i> <br>Pending</button>
                    <button class=\"d-sm-inline-block btn btn-sm btn-danger shadow-sm kotak\" style=\"width:15%;margin-top:5px;\" id=\"tolak$keyisi\" data-toggle=\"modal\" data-target=\"#modal_verifikasi_sedang\"><i class='fas fa-backward fa-sm text-white-100'></i> <br>Tolak</button>
                    <button class=\"d-sm-inline-block btn btn-sm btn-info shadow-sm kotak\" style=\"width:15%;margin-top:5px;\" id=\"detail_surat$keyisi\" ><i class='fas fa-cog fa-sm text-white-100'></i> <br>Detail</button>
                    <button class=\"d-sm-inline-block btn btn-sm btn-primary shadow-sm kotak\" style=\"width:100%;margin-top:5px;\" id=\"unggah_balasan$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-upload fa-sm text-white-100'></i> <br>Unggah Surat Balasan</button>
                    </td></tr>";
                ...
                echo "
                    ...
                    <div class='modal fade' id='modal_verifikasi' role='dialog' style='z-index:100000;'>
                        ...
                        <div class='modal-content' ".$this->CI->config->item('style_modal_admin').">
                            ...
                            <center>
                            <div id='pra_verifikasi' style='width:65%;' align='center' >
                            Mohon ditunggu, data sedang dimuat ke memori sebelum dikirim...
                            <i class='fa-3x fas fa-spinner fa-pulse' ".$this->CI->config->item('style_progres_bulat_admin')."></i>
                            <!--
                            <div class='progress' style='margin-top:50px; height:20px'>
                                <div class='progress-bar progress-bar-striped active' role='progressbar' aria-valuenow='90' aria-valuemin='0' aria-valuemax='100' style='width:100%'>
    ...
    function penampil_tabel_akun_tamu_pegawai ($array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        ...
        if (!$Recordset1) {
            ...
            foreach($Recordset as $isi){
                foreach ($tampung_key as $k) {
                    if($k=='cookie'||$k=='timestamp_daftar'||$k=='pass_sampai_tgl'||$k=='pass_berlaku_mulai'||$k=='direktori_foto'){
                    }else{
                        echo "<tr><td align=right>".ucwords(implode(' ',explode('_',$k)))."</td><td align=left valign=top>".$isi[$k]."</td></tr>";
                    }
                } 
            }
    ...
    function penampil_tabel_akun_pegawai ($array_atribut,$Recordset,$submenu,$kolom_direktori='direktori_foto',$direktori_avatar='/public/img/no-image.jpg'){
        ...
        if (!$Recordset) {
            ...
            foreach($Recordset as $key=>$isi){
                if(is_string($key)) {
                    if($key=='cookie'||$key=='timestamp_daftar'||$key=='pass_sampai_tanggal'||$key=='pass_berlaku_mulai'||$key=='direktori_foto'){
                    }else{
                        echo "<tr><td align=right>".ucwords(implode(' ',explode('_',$key)))."</td><td align=left valign=top>".$isi."</td></tr>";
                    }
                    //OLD echo "<tr><td align=right>$key</td><td align=left valign=top>".$isi."</td></tr>";
                } 
            }
