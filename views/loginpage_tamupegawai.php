...
<head>
    <title>Akun Tamu e-Office BKD Provinsi Sulawesi Selatan</title>
    <!-- Meta-Tags -->
	...
	<div class="layer">
		...
		<div class="content-w3ls">
			<div class="text-center icon">
				<span class="text-login" style="font-size:25px;color:#fff">Login Akun Tamu</span>
			</div>
				...
				<form action="<?php echo site_url('login/logintamupegawai/process') ?>" method="post" accept-charset="utf-8">
					<div class="field-group">
						...
						<div class="wthree-field">
							<input name="idtamu" id="text1" type="text" value="" placeholder="Masukkan ID Tamu" required>
						</div>
					</div>
					<div class="field-group">
