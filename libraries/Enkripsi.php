...
class Enkripsi {
	...
	public function simplesignature_just_hashing_obselet($data,$salt='frontoffice_bkd_sulsel_2020')
	{
		return hash('sha256',serialize($data).$salt);
    }

	public function simplesignature_just_hashing_tes($data,$salt='frontoffice_bkd_sulsel_2020')
	{
		return serialize($data).$salt;
    }
